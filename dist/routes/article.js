...
router.get("/p/:category/:slug", _install["default"].redirectToLogin, /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6(req, res, next) {
    var temp_articles, settings, user, slug, article, bookmark, book, art, category, _length, r, related, nextprev, ips, sameArticle, articleCount, indexof, view_article, comments, _articleBody, saveText, _res, ip, payload, _view_article, _comments, _articleBody2, _saveText;
    ...
    return _regenerator["default"].wrap(function _callee6$(_context6) {
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 2:
            temp_articles = _context6.sent;
            temp_articles.forEach( /*#__PURE__*/function () {
              var _ref6 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(article) {
                var _result, articlebody;

                return _regenerator["default"].wrap(function _callee5$(_context5) {
                  while (1) {
                    switch (_context5.prev = _context5.next) {
                      case 0:
                        _result = changeTohtml(article.body);
                        _context5.next = 3;
                        return _body["default"].create({
                          articleId: article._id,
                          html: _result.article
                        });

                      case 3:
                        articlebody = _context5.sent;
                        _context5.next = 6;
                        return _articles["default"].updateOne({
                          _id: article._id
                        }, {
